      ...
      <TerminalWindow title="about.md">
        ...
        >
          <section className="space-y-3 text-app-soft">
            ...
            <p>
              My passion is building software to deliver value while learning and exploring
              technologies.
            </p>
          </section>
          ...
          <section className="space-y-3 text-app-soft">
            ...
            <p>
              Cloud infrastructure, operating systems, networking, embedded systems, compilers and
              language learning.
            </p>
          </section>
        </CommandPrompt>
