...
export default function TerminalNav() {
  return (
    <nav className="mb-6 border-b border-app-border-subtle pb-4">
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2 font-mono text-sm text-app-muted">
        <Link
          href="/"
        ...
        >
          <span className="relative shrink-0" style={{ width: 26, height: 24 }}>
            <Image
          ...
          <span className="text-sm sm:text-base">dorayaki</span>
        </Link>
